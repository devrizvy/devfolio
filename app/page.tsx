      ...
      <div className="w-full max-w-[800px] h-[90dvh] max-h-[1186px] flex justify-center items-center overflow-hidden relative  shadow-2xl bg-black">
        {!hasEntered ? (
          ...
          <>
            ...
            <div
              className={`absolute inset-0 bg-gradient-to-b from-[#06080a] via-[#000000] to-[#040406] text-white p-6 md:p-12 flex flex-col transition-opacity duration-1000 overflow-y-auto overflow-x-hidden no-scrollbar ${
                isVideoEnded
                  ? "opacity-100 z-10"
            ...
            >
              ...
              <div className="flex flex-col md:flex-row items-start gap-8 mb-16 shrink-0">
                {/* 3D Model Container */}
                ...
                <div className="flex-1 mt-4 md:mt-10">
                  <h1
                    ...
                    className="text-4xl md:text-5xl tracking-[0.2em] mb-4 text-[#e0dfd5]"
                  >
                    Rizvy
                  </h1>
                  <h2
                    style={{ fontFamily: "var(--font-cinzel)" }}
                    className="text-xl md:text-2xl text-[#8e9496] tracking-widest mb-4 uppercase"
                  >
                    Web Developer
                  </h2>
                  <p className="text-gray-300/80 text-sm md:text-base leading-relaxed mb-6 max-w-xl font-light">
                    I spend my time building powerful, scalable apps that solve
                    unique niche problems most people never talk about. I dive
                    deep into every project and love pushing performance to the
                    absolute edge through smart architecture and relentless
                    optimization.
                  </p>
                  <div>
                    <h3
              ...
              <div className="flex flex-col gap-16 md:gap-24 mt-12 w-full relative max-w-4xl mx-auto shrink-0 pb-16">
                ...
                >
                  <ul className="space-y-4">
                    ...
                    <li className="flex items-center gap-3">
                      <span className="text-white/20 text-xs">✦</span> Technical
                      Blog Writer
                    </li>
                    <li className="flex items-center gap-3">
